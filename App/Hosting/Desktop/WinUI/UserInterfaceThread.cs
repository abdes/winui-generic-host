...
/// </summary>
public class UserInterfaceThread : BaseUserInterfaceThread<HostingContext>
{
    ...
    public UserInterfaceThread(IServiceProvider serviceProvider, IHostApplicationLifetime lifetime, HostingContext context, ILoggerFactory loggerFactory)
        : base(lifetime, context, loggerFactory?.CreateLogger<UserInterfaceThread>() ?? NullLoggerFactory.Instance.CreateLogger<UserInterfaceThread>())
